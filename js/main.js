...
$(document).ready(function() {
	...
	$("#season, #season1, #season2, #season3, #season4").change(function () {
        ...
        if (val == "2018"){
            ...
            $(player).html("<option value='Isaiah_Thomas_Stats_2017'>BOS - Isaiah Thomas</option><option value='Russell_Westbrook_Stats_2017'>OKC - Russell Westbrook &#9734</option><option value='James_Harden_Stats_2017'>HOU - James Harden</option><option value='Kawhi_Leonard_Stats_2017'>SAS - Kawhi Leonard</option><option value='LeBron_James_Stats_2017'>CLE - LeBron James</option><option value='Stephen_Curry_Stats_2017'>GSW - Stephen Curry</option><option value='John_Wall_Stats_2017'>WAS - John Wall</option><option value='Giannis_Antetokounmpo_Stats_2017'>MIN - Giannis Antetokounmpo</option><option value='Anthony_Davis_Stats_2017'>NOP - Anthony Davis</option><option value='Kevin_Durant_Stats_2017'>GSW - Kevin Durant</option><option value='DeMar_DeRozan_Stats_2017'>TOR - DeMar DeRozan</option><option value='Kyrie_Irving_Stats_2017'>CLE - Kyrie Irving</option><option value='Klay_Thompson_Stats_2017'>GSW - Klay Thompson</option><option value='Draymond_Green_Stats_2017'>GSW - Draymond Green</option><option value='Nikola_Jokic_Stats_2017'>DEN - Nikola Jokic</option><option value='Jimmy_Butler_Stats_2017'>CHI - Jimmy Butler</option><option value='DeMarcus_Cousins_Stats_2017'>NOP - DeMarcus Cousins</option><option value='Chris_Paul_Stats_2017'>LAC - Chris Paul</option>");
        } else if (val == "2016") {
            $(player).html("<option value='Stephen_Curry_Stats_2016'>GSW - Stephen Curry &#9734</option><option value='Kawhi_Leonard_Stats_2016'>SAS - Kawhi Leonard</option><option value='LeBron_James_Stats_2016'>CLE - LeBron James</option><option value='Russell_Westbrook_Stats_2016'>OKC - Russell Westbrook</option><option value='Kevin_Durant_Stats_2016'>OKC - Kevin Durant</option><option value='Chris_Paul_Stats_2016'>LAC - Chris Paul</option><option value='Draymond_Green_Stats_2016'>GSW - Draymond Green</option><option value='Damian_Lillard_Stats_2016'>POR - Damian Lillard</option><option value='James_Harden_Stats_2016'>HOU - James Harden</option><option value='Kyle_Lowry_Stats_2016'>TOR - Kyle Lowry</option>");
        } else if (val == "2015") {
            $(player).html("<option value='Stephen_Curry_Stats_2015'>GSW - Stephen Curry &#9734</option><option value='James_Harden_Stats_2015'>HOU - James Harden</option><option value='LeBron_James_Stats_2015'>CLE - LeBron James</option><option value='Russell_Westbrook_Stats_2015'>OKC - Russell Westbrook</option><option value='Anthony_Davis_Stats_2015'>NOP - Anthony Davis</option><option value='Chris_Paul_Stats_2015'>LAC - Chris Paul</option><option value='LaMarcus_Aldridge_Stats_2015'>POR - LaMarcus Aldridge</option><option value='Marc_Gasol_Stats_2015'>MEM - Marc Gasol</option><option value='Blake_Griffin_Stats_2015'>LAC - Blake Griffin</option><option value='Tim_Duncan_Stats_2015'>SAS - Tim Duncan</option><option value='Kawhi_Leonard_Stats_2015'>SAS - Kawhi Leonard</option><option value='Klay_Thompson_Stats_2015'>GSW - Klay Thompson</option>");
        }
    });
	...
	function drawGraph(){
		...
		queue.awaitAll(function(error,csvDataSets){
			...
			var colors = ['#FFD700','steelblue','purple','darkgreen','#d62728','orange']
